...
export class SelectServiceV2Component extends Component<Props> {
    ...
    getEmptyMessage = () => {
        ...
        let emptyStateMsg = "No service right now.If you don’t think this is right, Please feel free to contact us.";
        return (
