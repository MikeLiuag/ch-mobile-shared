...
export class VideoPlayer extends Component {
    ...
    renderStartButton() {
        ...
        return (
            this.state.isFullPlayer ? <TouchableOpacity
                    style={[styles.playButton, customStyles.playButton]}
                    onPress={this.onStartPress}
                >
                    <Icon style={[styles.playArrow, customStyles.playArrow]} name="play-arrow" size={this.props.playArrowSize?this.props.playArrowSize:62}/>
                </TouchableOpacity>
                :
                ...
                >
                    {
                        this.state.isGradientP ?
                            <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 0}}
                                            colors={["#1ed0de", "#34b6fe", "#6078ea"]}
                                            style={customStyles.greControl}>
                                <Icon style={[styles.playArrow, customStyles.playArrow]} name="play-arrow" size={this.props.playArrowSize?this.props.playArrowSize:42}/>
                            </LinearGradient> :
                            this.props.refScreen === 'revamp'
                                ?
                                <FontAwesome5Icon style={[styles.playArrow, customStyles.playArrow]} name="play" size={this.props.playArrowSize?this.props.playArrowSize:42}/>
                                :
                                <Icon style={[styles.playArrow, customStyles.playArrow]} name="play-arrow" size={this.props.playArrowSize?this.props.playArrowSize:42}/>
                    }
                </TouchableOpacity>
        ...
        return (
            this.state.isFullPlayer ?
                <View style={[styles.controls, customStyles.controls]}>
                    ...
                    <View style={{ width: '100%'}}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between'}}>
                            ...
                            <Text style={styles.timingText}>{this.getFormattedTimeFromSeconds(this.state.duration)}</Text>
                        </View>
                    </View>
                ...
                <View style={[styles.controls, customStyles.controls]}>
                    ...
                    {
                        this.state.isGradientP? null : <Text style={styles.timingText}>{this.state.currentTime}/{this.getFormattedTimeFromSeconds(this.state.duration)}</Text>
                    }
            ...
            <View style={customStyles.videoWrapper}>
                <Video
                    ...
                    style={[
                        ...
                        style,
                        customStyles.video,
                        this.state.isFullPlayer? {backgroundColor: 'transparent'} : null
                    ]}
                    ref={p => { this.player = p; }}
    ...
    renderContent() {
        ...
        if (!isStarted && thumbnail) {
            ...
            return (
                this.state.isFullPlayer ?
                    <View style={[styles.preloadingPlaceholder, this.getSizeStyles(), style, { backgroundColor: 'transparent'}]}>
                        {this.renderStartButton()}
                    </View>
                    :
                    <View style={this.state.isGradientP?[styles.preloadingPlaceholder,{justifyContent:'flex-start'}, this.getSizeStyles(), style]:[styles.preloadingPlaceholder, this.getSizeStyles(), style]}>
                        {this.renderStartButton()}
                        {(this.props.timeRequired ?
                            <Text style={styles.audioTextNoPlay}>{this.props.timeRequired} minutes listen time</Text> : null)}
                    </View>
            );
        }
