...
import {defaultPageSize, isCloseToBottom,AlertUtil} from '../utilities';
...
export class InlineSearch extends Component<Props> {
    ...
    updateIfCompleted = contentList => {
        ...
        contentList.forEach(contentItem => {
            contentItem.markedAsCompleted =
                completed.indexOf(contentItem.slug) > -1 ? true : false;
        });
    };
...
const styles = StyleSheet.create({
    ...
    slideSearch: {
        ...
        paddingTop: isIphoneX()? statusHeight + 10 : statusHeight + 12,
        flexDirection: 'row',
