...
import book from './../assets/animations/book';
import {addTestID} from "../utilities";

export class AnimatedLearningLibView extends Component<Props> {
            ...
            <TouchableOpacity
                ...
                <View style={styles.animWrapper}>
                    <LottieView
                        ...
                        source={book} autoPlay loop/>
                    <Text style={styles.animText}>Learning Library</Text>
                </View>
            </TouchableOpacity>
        );
    }
